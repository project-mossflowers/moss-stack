...
import {
  ...
  itemsReadItems,
  itemsUpdateItem,
  oauth2GetOauth2Status,
  oauth2Oauth2Callback,
  oauth2Oauth2Login,
  privateCreateUser,
  systemHealthCheck,
  usersCreateUser,
...
export const usersReadUsersInfiniteQueryKey = (
  options?: Options<UsersReadUsersData>,
): QueryKey<Options<UsersReadUsersData>> =>
  createQueryKey('usersReadUsers', options, true)
 ...
 * Paginated list of users with metadata
 */
export const usersReadUsersInfiniteOptions = (
  options?: Options<UsersReadUsersData>,
) => {
  return infiniteQueryOptions<
    UsersReadUsersResponse,
    AxiosError<UsersReadUsersError>,
    InfiniteData<UsersReadUsersResponse>,
    QueryKey<Options<UsersReadUsersData>>,
    | number
    | Pick<
        QueryKey<Options<UsersReadUsersData>>[0],
  ...
  >(
    // @ts-ignore
    {
      ...
      queryKey: usersReadUsersInfiniteQueryKey(options),
    },
  )
}
...
export const oauth2Oauth2LoginQueryKey = (
  options: Options<Oauth2Oauth2LoginData>,
) => createQueryKey('oauth2Oauth2Login', options)

/**
 * Oauth2 Login
 * Initiate OAuth2 login with specified provider
 */
export const oauth2Oauth2LoginOptions = (
  options: Options<Oauth2Oauth2LoginData>,
) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
      const { data } = await oauth2Oauth2Login({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true,
    ...
    queryKey: oauth2Oauth2LoginQueryKey(options),
  })
}

export const oauth2Oauth2CallbackQueryKey = (
  options: Options<Oauth2Oauth2CallbackData>,
) => createQueryKey('oauth2Oauth2Callback', options)

/**
 * Oauth2 Callback
 * Handle OAuth2 callback from provider
 */
export const oauth2Oauth2CallbackOptions = (
  options: Options<Oauth2Oauth2CallbackData>,
) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
      const { data } = await oauth2Oauth2Callback({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true,
    ...
    queryKey: oauth2Oauth2CallbackQueryKey(options),
  })
}

export const oauth2GetOauth2StatusQueryKey = (
  options?: Options<Oauth2GetOauth2StatusData>,
) => createQueryKey('oauth2GetOauth2Status', options)

/**
 * Get Oauth2 Status
 * Check OAuth2 provider configuration status
 */
export const oauth2GetOauth2StatusOptions = (
  options?: Options<Oauth2GetOauth2StatusData>,
) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
      const { data } = await oauth2GetOauth2Status({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true,
    ...
    queryKey: oauth2GetOauth2StatusQueryKey(options),
  })
}
